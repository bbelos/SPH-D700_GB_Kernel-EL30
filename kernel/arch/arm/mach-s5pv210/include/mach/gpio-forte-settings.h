...
// Forte
	...
	{S5PV210_GPA0(6), S3C_GPIO_INPUT, S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_DOWN},//Changes as per hardware   
...
//	{GPIO_HALL_SW, S3C_GPIO_INPUT, S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_NONE}, //GPIO_BUCK_2_EN
        //{GPIO_EAR_DET, S3C_GPIO_INPUT, S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_NONE}, // changed as per hardware
...
//	{GPIO_3P_SEND_END, S3C_GPIO_INPUT,  S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_NONE}, //NONE}, //GPIO_GPH11 // changed as per hardware
	...
	//{GPIO_WLAN_HOST_WAKE, S3C_GPIO_INPUT, S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_NONE}, //GPIO_GPH14 // changed as per hardware
	{GPIO_EAR_SEND_END, S3C_GPIO_INPUT,  S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_DOWN}, //GPIO_GPH15
       // {GPIO_BT_HOST_WAKE, S3C_GPIO_INPUT, S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_NONE}, // changed as per hardware
...
//	{GPIO_T_FLASH_DETECT, S3C_GPIO_INPUT, S3C_GPIO_SETPIN_NONE,  S3C_GPIO_PULL_NONE},	//GPIO_CP_RST // changed as per hardware
};
#endif
